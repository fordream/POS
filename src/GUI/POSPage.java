...
public class POSPage extends SimpleJFrame implements ActionListener, KeyListener, FocusListener{
	...
	public POSPage() 
	{
		...
		developersLabel.setText("<html>Developed by ÄÄÇ»ÅÍÇÐºÎ<br>2011105038 ¹Úµ¿¿ø 2011105062 À¯µ¿±Ô<br>"
				+ "2014105002 °û´ëÈÆ 2014105076 ÀÌÂù¿µ</html>");
		developersLabel.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 14));
