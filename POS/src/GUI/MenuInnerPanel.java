...
public class MenuInnerPanel extends JPanel implements ActionListener, KeyListener, MouseListener, MouseWheelListener, FocusListener{
        ...
        public MenuInnerPanel(PosData data)
        {
                ...
                addMenuToListButton.setPressedIcon(new ImageIcon("img/plus_button_pressed.png"));
                ...
                subMenuFromListButton.setPressedIcon(new ImageIcon("img/minus_button_pressed.png"));
        ...
        public void addMenuconfirm()
        {
                ...
                if(getMenuType() == FOOD)
                {
                        ...
                        if( MCon.searchMenu(food.getName()) != -1)
                        {
                                ...
                                {
                                        JOptionPane.showMessageDialog(this, "Á¾·ù°¡ ´Ù¸¥ °°Àº ÀÌ¸§ÀÇ ¸Þ´º°¡ Á¸ÀçÇÕ´Ï´Ù! ¼öÁ¤ÀÌ ºÒ°¡´ÉÇÕ´Ï´Ù!");
                                        return;
                                }
                        }
...
//                      count.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                ...
                {
                        if(orderListButton.get(i).getMenuName().equals(getCurrentOrderName()) && getCurrentMenuType() == ORDER)
                                orderListButton.get(i).setBackground(new Color(200, 255, 200));


                        tableMenuListPanel.add( orderListButton.get(i) ).setBounds(3, (k * 50)+3, 194, 50);
                        k++;
                        if(k > 5)
                                break;
                }
...
//                              count.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                                ...
                                System.out.println("Current Food Index : " + getCurrentFoodName() + "  " + i );
                                foodButton.setBackground(Color.WHITE);
                ...
                {
                        if(foodListButton.get(i).getMenuName().equals(getCurrentFoodName()) && getCurrentMenuType() == FOOD)
                                foodListButton.get(i).setBackground(new Color(200, 255, 200));

                        foodListPanel.add( foodListButton.get(i) ).setBounds(3, 30 + (k * 54), 194, 54);
                        k++;
                        if(k > 4)
                                break;
                }
...
//                              count.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                                ...
                                System.out.println("Current Drink Index : " + getCurrentDrinkName() + "  " + i );
                                drinkButton.setBackground(Color.WHITE);
                ...
                {
                        if(drinkListButton.get(i).getMenuName().equals(getCurrentDrinkName()) && getCurrentMenuType() == DRINK)
                                drinkListButton.get(i).setBackground(new Color(200, 255, 200));

                        drinkListPanel.add( drinkListButton.get(i) ).setBounds(3, 30 + (k * 54), 194, 54);
                        k++;
                        if(k > 4)
                                break;
                }
