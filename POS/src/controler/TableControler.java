...
public class TableControler {
   ...
   public void subOrder(Table myTable, String menuName)
   {
      try
      {
         int tableIndex = Table.getSelectedTable();
         int menuIndex = searchOrderedMenu( tableIndex, menuName );
   ...
   public void deleteOrder(Table myTable, String menuName)
   {
      try
      {
         int tableIndex = searchTable(myTable);
   ...
   public int searchOrderedMenu(int myTableIndex, String name)
   {
      int index = -1;
      
      for(int i = 0; i < getData().getTableList().get(myTableIndex).getOrderList().size(); i++)
      {
         if( name.equals( getData().getTableList().get(myTableIndex).getOrderList().get(i).getName() ) )
         {
            index = i;
            break;
         }
